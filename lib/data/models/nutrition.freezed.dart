...
Nutritions _$NutritionsFromJson(
  Map<String, dynamic> json
) {
    return _Nutrition.fromJson(
      json
    );
}

/// @nodoc
mixin _$Nutritions implements DiagnosticableTreeMixin {

 int get calories; double get fat; double get sugar; double get carbohydrates; double get protein;
/// Create a copy of Nutritions
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NutritionsCopyWith<Nutritions> get copyWith => _$NutritionsCopyWithImpl<Nutritions>(this as Nutritions, _$identity);

  /// Serializes this Nutritions to a JSON map.
  Map<String, dynamic> toJson();

@override
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'Nutritions'))
...
/// @nodoc
abstract mixin class $NutritionsCopyWith<$Res>  {
  factory $NutritionsCopyWith(Nutritions value, $Res Function(Nutritions) _then) = _$NutritionsCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$NutritionsCopyWithImpl<$Res>
    implements $NutritionsCopyWith<$Res> {
  _$NutritionsCopyWithImpl(this._self, this._then);

  final Nutritions _self;
  final $Res Function(Nutritions) _then;
...
/// Adds pattern-matching-related methods to [Nutritions].
extension NutritionsPatterns on Nutritions {
...
class _Nutrition with DiagnosticableTreeMixin implements Nutritions {
  const _Nutrition({this.calories = 0, this.fat = 0, this.sugar = 0, this.carbohydrates = 0, this.protein = 0});
...
/// @nodoc
abstract mixin class _$NutritionCopyWith<$Res> implements $NutritionsCopyWith<$Res> {
